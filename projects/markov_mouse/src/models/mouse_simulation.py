"""Mouse in a house Markov chain simulation.

This module implements a simulation of a mouse moving between 5 rooms arranged in a circle,
with specified transition probabilities between adjacent rooms.
"""

import numpy as np
from typing import List, Tuple
from ..core.markov_chain import MarkovChain
from ..utils.visualization import plot_distribution_evolution, plot_transition_matrix
